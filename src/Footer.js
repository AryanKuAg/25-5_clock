...
function Footer({reset}) {
  return (
    <div className="flex justify-around mt-8 mx-8">
      <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" className="cursor-pointer">
        <path fill="#fff" d="M14.9 39.95V7.75l25.25 16.1Z" />
      </svg>
      <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" className="cursor-pointer">
        <path fill="#fff" d="M26.2 40.1V7.85h13.95V40.1Zm-18.35 0V7.85H21.8V40.1Z" />
      </svg>
      <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" className="cursor-pointer" onClick={()=> {reset()}}>
